...
\textbf{Deadline:} 01-Oct.-2020, 11:59 PM EST. 
...
(d) "Monte Carlo integration" is estimation of population moments of a rv $X$ by the corresponding sample moments whenever one can simulate iid variates $X_1,X_2,\ldots$ from the sampling distribution of $X$. I.e., using the law of large numbers (and another result known as the continuous mapping theorem) $\bar{X}_n \rightarrow E(X)$ and $S_n \rightarrow Var(X)$ as $n\rightarrow \infty$. 
