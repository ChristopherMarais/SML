...
print(paste("The sample mean of the sample of variances is: ", myRound(samp_mean)))
print(paste("The sample variance of the sample of variances is: ", myRound(samp_var)))
