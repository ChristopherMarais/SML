...
print(paste("The sample mean is (A): ", myRound(samp_mean)))
print(paste("The sample variance is (A): ", myRound(samp_var)))
hist(var_vec,
     ylim=c(0,200),
     breaks=20,
     xlim=c(0,2),
     main="Histogram of sample variances (A)")
...
print(paste("The sample mean is (B): ", myRound(B_samp_mean)))
print(paste("The sample variance is (B): ", myRound(B_samp_var)))
hist(B_var_vec,
     ylim=c(0,200),
     breaks=20,
     xlim=c(0,2),
     main="Histogram of the estimated sample variances (B)")
...
print(paste("The sample mean is (C): ", myRound(C_samp_mean)))
print(paste("The sample variance is (C): ", myRound(C_samp_var)))
hist(C_var_vec,
     ylim=c(0,200),
     breaks=20,
     xlim=c(0,2),
     main="Histogram of the estimated sample variances (C)")
```
...
for(n in n_vec){
  ...
  samp_mean = mean(var_vec)
  samp_var = var(var_vec)
  print(paste("The Monte Carlo mean is ", "(n=",n,"): ", myRound(samp_mean)))
  print(paste("The Monte Carlo variance is ", "(n=",n,"): ",  myRound(samp_var)))
  hist(var_vec,
       ylim=c(0,200),
       breaks=20,
       xlim=c(0,2),
  ...
  B_samp_mean = mean(B_var_vec)
  B_samp_var = var(B_var_vec)
  print(paste("The Parametric mean is ", "(n=",n,"): ", myRound(B_samp_mean)))
  print(paste("The Parametric variance is ", "(n=",n,"): ", myRound(B_samp_var)))
  hist(B_var_vec,
       ylim=c(0,200),
       breaks=20,
       xlim=c(0,2),
  ...
  C_samp_mean = mean(C_var_vec)
  C_samp_var = var(C_var_vec)
  print(paste("The Non-Parametric mean is ", "(n=",n,"): ", myRound(C_samp_mean)))
  print(paste("The Non-Parametric variance is ", "(n=",n,"): ", myRound(C_samp_var)))
  hist(C_var_vec,
       ylim=c(0,200),
       breaks=20,
       xlim=c(0,2),
...
parametric vs nonparametric bootstrap. You can treat the results of the Monte Carlo-based inference
(under simulation from the true distribution) as the golden standard, against which the parametric
and nonparametric bootstrap results are compared.
