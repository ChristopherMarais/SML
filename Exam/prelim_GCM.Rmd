...
i_vec = seq(5)
mcr_i_pstar_df = data.frame(matrix(0, nrow = length(p_star_vec), ncol = length(i_vec)+1))
mcr_i_pstar_df[,1] = p_star_vec
...
knitr::kable(mcr_i_pstar_df, format = "markdown")
```
