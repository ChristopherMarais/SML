...
```
The optimal tuning parameter for d in this case is 2. when d=2 the total MSE for all 5 folds in cross validation is the lowest. However, the difference between d=1 and d=2 is not very large and it  might be more effective to go with d=1 in line wiht Occam's razor. 
